<body>
    ...
    <div class="col-12 bg-gradient-info" style="width: 100%;">
        <nav class="navbar navbar-expand-lg navbar-dark bg-gradient-info ">
            <div class="container">
                <a href="/"><i class="fas fa-cloud-meatball navbar-brand"> HeartBeat</i></a>
                <ul class="navbar-nav ml-auto float-right">
                    <li class="nav-item">
                        <a class="nav-link" href="/login"><i class="fas fa-sign-in-alt mr-2"> login</i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas mr-2"> Contact Us</i></a>
                    </li>
                </ul>
            </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="container">
                    <div class="#"><br>
                        <h5 class="text-dark font-weight-bold text-left">
                            ...
                            <span style="float : right">
                                <button class="bg-gradient-info"><a href="/user/survey"
                                        class="text-light text-decoration-none">di sini</a>
                                </button>
                            </span>
                        </h5>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-4">
                                <h3 class="fas fa-cloud-meatball bg-light text-info"> HeartBeat</h3>
                            </div>
                        </div>
                    </div> <br>
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <p>HeartBeat merupakan sebuah sistem aplikasi berbasis website dalam bidang
